...
import { NsKhenthuong_Kyluat } from './../models/ns-quatrinh';
...
export class NsKhenthuongKyluatService {

  private readonly api = getRoute('nhansu-kyluat/');
  constructor(private http: HttpClient,
    private helperService: HelperService,
    private httpParamsHeplerService: HttpParamsHeplerService) { }

  list(id: number, filter?: { search: string }): Observable<NsKhenthuong_Kyluat[]> {
